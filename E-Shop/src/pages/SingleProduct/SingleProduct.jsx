...
const SingleProduct = ({AddToCart}) => {
  ...
  return (
    <>
      <div>
        <div className=" w-[60%] mx-auto mt-4 flex ">
        <p
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex">
                  ...
                  <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={addtoSingleProduct}>
                    Add to Cart
                  </button>
