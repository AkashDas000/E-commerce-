    ...
    <footer className=' bg-black text-white'>
        <div className=' container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
            ...
            <div className=' w-64 md:mx-0 mx-auto text-center md:text-left'>
                ...
                Kha<span className=' text-red-500'>rido</span>
                </h3>
            </div>
            ...
            <div className=' flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 md:text-left text-center'>
                ...
                <div className=' lg:w-1/4 md:w-1/2 w-full px-4'>
                    <h2 className=' title-font font-medium trackng-widest text-lg mb-3'>
                        Menu
                    </h2>
                ...
                <div className=' lg:w-1/4 md:w-1/2 w-full px-4'>
                    ...
                    <ul className=' list-none mb-10'>
                        ...
                        <li className=' mt-1'>+67845689</li>
                        <li className=' mt-1'>New Blog</li>
                        <li className=' mt-1'>+824152474</li>
                    </ul>
                </div>
        ...
        <div className=' bg-gray-500 text-white'>
            <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
                <p className=' text-sm text-center sm:text-left'>
                    2024 Kharido -<span>@copyright</span>
                </p>
